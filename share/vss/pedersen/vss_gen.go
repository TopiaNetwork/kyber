...
func (z *Dealer) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		err = dc.ReadNil()
		if err != nil {
			err = msgp.WrapError(err, "Aggregator")
			return
		}
		z.Aggregator = nil
	} else {
...
func (z *Justification) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	if dc.IsNil() {
		...
		if err != nil {
			err = msgp.WrapError(err, "Deal", "SessionID")
			return
		}
		z.Deal.T, err = dc.ReadUint32()
		if err != nil {
			err = msgp.WrapError(err, "Deal", "T")
			return
		}
	}
	z.Signature, err = dc.ReadBytes(z.Signature)
